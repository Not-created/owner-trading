...
Wires all modules; runs startup tasks (indexes, seeding, plugin bootstrap).
"""
...
from modules.ai_core.presets_router import router as ai_presets_router
...
from modules.ai_developer.router import router as ai_dev_router
from modules.ai_developer.core_router import router as ai_dev_core_router
...
app = FastAPI(title="Enterprise AI Trading Platform", version="1.1.0")
...
app.include_router(ai_dev_core_router)
