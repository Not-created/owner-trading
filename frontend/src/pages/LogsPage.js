...
export default function LogsPage() {
  ...
  return (
    <div data-testid={TEST_IDS.logs.root} className="p-6 space-y-4 max-w-[1400px]">
      <div>
        <div className="font-mono text-[10px] text-term-muted uppercase tracking-wider">// audit.stream</div>
        <h1 className="font-display text-3xl font-bold tracking-tight">Audit & Activity Logs</h1>
      </div>
      ...
      <section className="border border-term-border bg-term-panel">
        ...
        <div className="p-3 font-mono text-[11px] leading-relaxed max-h-[70vh] overflow-y-auto">
